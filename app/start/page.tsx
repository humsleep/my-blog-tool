          ...
          <div>
            ...
            <div className="mb-6">
              <input
                ...
                className="w-full px-0 py-4 bg-transparent border-0 border-b-2 border-rule text-ink text-2xl sm:text-3xl placeholder-ink-faint focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-colors"
              />
            </div>
