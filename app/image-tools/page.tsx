    ...
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen py-4 sm:py-6 md:py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          ...
          <a
            href="/image-search"
            className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-medium rounded-lg transition-colors self-start sm:self-auto"
          >
        ...
        <div className="mb-4 sm:mb-6 bg-white dark:bg-slate-800/80 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-4 shadow-sm">
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 sm:justify-center">
            ...
            <button
              ...
              disabled={!image}
              className="px-4 py-3 sm:py-2 bg-emerald-500 text-white rounded-lg font-medium hover:bg-emerald-600 active:bg-emerald-700 transition-colors disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed flex items-center justify-center gap-2 min-h-[44px] touch-manipulation text-sm sm:text-base"
              title="다운로드"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="mb-6">
                    ...
                    <label className="flex items-center gap-2 text-sm text-gray-700">
                      <input
                        ...
                        className="w-4 h-4 text-emerald-500 border-rule-soft rounded focus:ring-emerald-500"
                      />
                      <span>비율 유지하기</span>
                    </label>
                  </div>
                  ...
                  <div className="mb-6 space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 items-center">
                            ...
                            <button
                              ...
                              className="px-3 py-2 bg-emerald-500 text-white rounded-lg text-xs font-medium hover:bg-emerald-600 transition-colors whitespace-nowrap flex-shrink-0"
                              title="90도 회전"
                            >
                              90° 회전
                            </button>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm font-medium bg-white"
                      >
