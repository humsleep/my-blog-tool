      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-5">
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mb-1">
            <Link href="/community/tips" className="hover:text-emerald-500 dark:hover:text-emerald-400">정보 공유</Link>
            <span>/</span>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-xs font-medium text-emerald-500 dark:text-emerald-400 hover:underline"
              >
                {preview ? '편집 보기' : '미리보기'}
              </button>
            </div>
